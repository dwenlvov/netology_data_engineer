...
С docker-compose можно ознакомиться по ССЫЛКЕ. 
...
# 4. ETL-процесс 
С самим DAG файлом можно ознакомиться ЗДЕСЬ
...
2. **Реализованы ETL-процесс**, обеспечивающие загрузку, обработку и трансформацию данных с проверкой качества.
3. **Использованы инструменты:**  
    * Airflow   
    * PostgreSQL  
    * pytest
4. **Проверки качества данных (DQ) включают:**  
    * Дедубликацию  
    * Обработка пропусков  
